...
{% block content %}
    <div class="row">
        <div class="col-xs-12">
            {{ flashSession.output() }}
            <h4 class="bar_style">Update Renewal | Mailgun ID: {{ renewal.mg_campaign_id }}</h4>
            <form action="" method="post">
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-primary"><i class="fa fa-check"></i> Update Renewal</button>
